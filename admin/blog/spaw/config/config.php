...
SpawConfig::setStaticConfigItem('DOCUMENT_ROOT', 'c:/inetpub/wwwroot/blog/admin/');
SpawConfig::setStaticConfigItem('SPAW_ROOT', 'c:/inetpub/wwwroot/spaw2/blog/admin/');
SpawConfig::setStaticConfigItem('SPAW_DIR', '/spaw2/blog/admin/');
*/
...
// toolbarset 
SpawConfig::setStaticConfigItem('default_toolbarset','blog');
// stylesheet
...
// Maian Weblog toolbar
SpawConfig::setStaticConfigItem('toolbarset_blog',
  array(
    "format" => "format",
    "style" => "style",
    "edit" => "edit",
...
// directories
// modified by maian script world.. 
SpawConfig::setStaticConfigItem(
