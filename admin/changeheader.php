...
include($_SERVER['DOCUMENT_ROOT'].'/donation/admin/code/functions.php');  
include($_SERVER['DOCUMENT_ROOT'].'/donation/admin/code/kfun.php');  
?>
<!DOCTYPE html>
<html>
  <head>
    ...
    <!-- Bootstrap 3.3.2 -->
    <link href="/donation/admin/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />    
    <!-- FontAwesome 4.3.0 -->
    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
    <!-- Ionicons 2.0.0 -->
    <link href="http://code.ionicframework.com/ionicons/2.0.0/css/ionicons.min.css" rel="stylesheet" type="text/css" />    
    <!-- Theme style -->
    <link href="/donation/admin/dist/css/AdminLTE.min.css" rel="stylesheet" type="text/css" />
    <!-- AdminLTE Skins. Choose a skin from the css/skins 
         folder instead of downloading all of them to reduce the load. -->
    <link href="/donation/admin/dist/css/skins/_all-skins.min.css" rel="stylesheet" type="text/css" />
    <!-- iCheck -->
    <link href="/donation/admin/plugins/iCheck/flat/blue.css" rel="stylesheet" type="text/css" />
    <!-- Morris chart -->
    <link href="/donation/admin/plugins/morris/morris.css" rel="stylesheet" type="text/css" />
    <!-- jvectormap -->
    <link href="/donation/admin/plugins/jvectormap/jquery-jvectormap-1.2.2.css" rel="stylesheet" type="text/css" />
    <!-- Date Picker -->
    <link href="/donation/admin/plugins/datepicker/datepicker3.css" rel="stylesheet" type="text/css" />
    <!-- Daterange picker -->
    <link href="/donation/admin/plugins/daterangepicker/daterangepicker-bs3.css" rel="stylesheet" type="text/css" />
    <!-- bootstrap wysihtml5 - text editor -->
    <link href="/donation/admin/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css" rel="stylesheet" type="text/css" />
    
     <!-- DATA TABLES -->
    <link href="/donation/admin/plugins/datatables/dataTables.bootstrap.css" rel="stylesheet" type="text/css" />
            ...
            <li <?php add_class('menu.php')  ?>>
              ...
              <a href="package.php">
               ...
               <ul class="treeview-menu">
                <li><a href="view/user/users.php"><i class="fa fa-circle-o"></i> Registered User's</a></li>
				<li><a href ="view/user/usersetting.php"><i class="fa fa-circle-o"></i>UserSetting</a></li>
				<li><a href ="view/user/usergroup.php"><i class="fa fa-circle-o"></i>Usergroup</a></li>
